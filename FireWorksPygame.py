...
SPEED_FLY_UP_MAX = 20 # Tốc độ lớn nhất của viên đạn bay lên (trước khi nổ)
SPEED_FLY_UP_MIN = 10 # Tốc độ nhỏ nhất của viên đạn bay lên (trước khi nổ)
...
def main():
	...
	sound = pygame.mixer.Sound("./firework.mp3")
	mainSoundChannel.play(sound)
